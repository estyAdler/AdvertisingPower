(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/material'), require('@angular/common'), require('@angular/common/http'), require('rxjs'), require('rxjs/operators')) :
    typeof define === 'function' && define.amd ? define('angular-material-fileupload', ['exports', '@angular/core', '@angular/material', '@angular/common', '@angular/common/http', 'rxjs', 'rxjs/operators'], factory) :
    (global = global || self, factory(global['angular-material-fileupload'] = {}, global.ng.core, global.ng.material, global.ng.common, global.ng.common.http, global.rxjs, global.rxjs.operators));
}(this, (function (exports, core, material, common, http, rxjs, operators) { 'use strict';
